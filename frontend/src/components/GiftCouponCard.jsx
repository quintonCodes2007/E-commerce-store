        ...
        <div space-y-4>
            <div>
                ...
                <input
                    type='text'
                    id='voucher'
                    className='block w-full rounded-lg border-gray-600 bg-gray-700 p-2.5 text-sm  text-white placeholder-grey-400 focus:border-red-500 focus:ring-red-500 '
            ...
            <motion.button
                type='button'
                className='flex mt-4 w-full items-center justify-center rounded-lg bg-red-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300'

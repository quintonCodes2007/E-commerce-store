        ...
        <form onSubmit={handleSubmit}>
            <div>
                ...
                <input
                    ...
                    className='mt-1 block w-full bg-gray-700 border-gray-600 rounded-md  shadow-sm py-2 px-3 focus:border-red-200 focus:ring-1 focus:ring-red-400 focus:outline-none mb-3'
            ...
            <div className='mt-1 flex items-center'>
                ...
                <label htmlFor="image" className='cursor-pointer bg-gray-700 py-2 px-3 border border-gray-600 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-1 focus:ring-offset  focus:ring-red-500'
                >
